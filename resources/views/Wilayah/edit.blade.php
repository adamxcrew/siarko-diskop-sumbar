                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <form method="POST" action="/wilayah/{{ $data->id }}" enctype="multipart/form-data" >
                                @csrf
                                @method('PUT')
                                ...
                                @if($data->gambar)
                                    <div>
                                        <div class="mb-5">
                                        <img style="maxwidth:200px;max-height:200px;"src="{{ url('logowilayah').'/'.$data->gambar }}" alt="">
                                        </div>
                                    </div>
                                @endif
                                <div class="form-group row">
                                ...
                                <div class="card-footer">  <!-- button Default -->
                                    <button type="submit" class="btn waves-effect waves-light btn-style btn-green" style="float: right; margin-left:20px">Update</button>
